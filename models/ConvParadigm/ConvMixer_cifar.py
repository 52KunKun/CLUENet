...
def ConvMixer(dim, depth, kernel_size=3, patch_size=4, n_classes=1000):
...
def convmixer_cifar(num_classes=100):
    return ConvMixer(dim=512,depth=10,n_classes=100)

if __name__ == '__main__':
    model = ConvMixer(dim=512,depth=10,n_classes=100)
