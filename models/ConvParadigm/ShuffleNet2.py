...
# https://github.com/ZhuYun97/ShuffleNet-v2-Pytorch?utm_source=chatgpt.com
...
def shufflenetv2_mini(num_classes=100,input_size=224):
  return ShuffleNet2(num_classes=num_classes, net_type=1.5,input_size=input_size)

def shufflenetv2_tiny(num_classes=100,input_size=224):
  return ShuffleNet2(num_classes=num_classes, net_type=2.0,input_size=input_size)
...
if __name__ == '__main__':
  model = shufflenetv2_tiny(num_classes=200)
  get_flops_ptflops_method(model, (3, 448, 448))
