...
if __name__ == '__main__':
    # model = efficientformerv2_s0(num_classes=100)
    # model = efficientformerv2_s1(num_classes=100)
    model = efficientformerv2_s2(num_classes=100)
    # model = efficientformerv2_l(num_classes=100)
    get_flops_ptflops_method(model, (3, 224, 224))
    # input_tensor = torch.randn((6,3,224,224))
    # oout = model(input_tensor)
    # print(oout.shape)