...
def ViT_mini_cifar(num_classes=100):
    image_size=32
    patch_size = 4
    embed_dim = 256
    layers = 8
    ...
    heads = 16
    # 前馈层 dim=dim
    net = ViT(image_size=image_size,patch_size=patch_size,num_classes=num_classes, dim=embed_dim, dim_head=int(embed_dim//heads), depth=layers, channels=channels, heads=heads,
              mlp_dim=embed_dim,pool='cls')
    return net
