...
# 2. 读取 CSV 文件
with open(r"./data/classes.txt", "r", encoding="utf-8") as f:
    for line in f:
        # 1. 去除首尾空白符
        line = line.strip()
        ...
        # 2. 使用 maxsplit=1 进行分割
        # 这样可以确保只在第一个空格处分割，后面的空格保留在 class_name 中
        # 例如: "3 great white shark" -> ['3', 'great white shark']
        ...
        try:
            ...
            if 0 <= idx < len(object_categories):
                object_categories[idx] = class_name.strip()
...
parser.add_argument('--data_path', type=str, default=r'D:\datasets\dataset\ip102_v1.1\images', help='path to imageFolder')
...
if __name__ == '__main__':
    ...
    # ... (你的读取代码) ...
    images, labels = read_txt_file("./data/train.txt")
    ...
    args.checkpoint = r"C:\Users\13779\Desktop\pth\IP102_pth\CLUA\CLUA_tiny\CLUA_tiny_best_model.pth"
    args.alpha = 1.0
    args.num_clu = 16
