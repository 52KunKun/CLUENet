...
def main(args):
    ...
    # Data dimensions set to 448*448
    ...
    trainset = data.MyDataset('./data/train.txt', label_txt='./data/classes2label.txt', data_root=data_root,
    ...
    testset = data.MyDataset('./data/test.txt', label_txt='./data/classes2label.txt', data_root=data_root,
                             transform=transforms.Compose(
    ...
    if args.weights != "":
        if os.path.exists(args.weights):
            ...
            # Raise exception if weight file is not found
            raise FileNotFoundError("not found weights file: {}".format(args.weights))

    # Load pre-trained weights if they exist
    # Note: model_name will refer to args.model, defined by the string in the execution file
    model_files = None
    if args.resume:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default='/root/shared-nvme/dataset/food-101/images')
