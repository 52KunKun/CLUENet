...
class MyDataSet(Dataset):
    ...
    def __init__(self,
        ...
        # json_path存放的是该数据子集拥有的全部图片文件名与图片标签码
        ...
        self.total_num = csv_data.shape[0]  # [行数，列数]  # 3列 标签索引码，图片名称，标签编码
        # 读取该image_dir下的所有文件  [所有文件名拼接好文件路径]
    ...
    def __getitem__(self, item): # 给出索引如何取
